<%-- 
    Document   : buscarAtencionXMascota
    Created on : 05-11-2017, 4:00:06
    Author     : Daniela
--%>
...
<html>
    <head>
        ...
        <title>MEDIPED</title>
            ...
            function buscar(){
                var formulario = document.getElementById("formulario");
                var idopcion = document.getElementById("ACCION");
                idopcion.value = 'BUSCAR_ATENCION_X_MASCOTA';
                formulario.submit();
    ...
    <body>
        <form id="formulario" name="formulario" action="./BuscarServlet" method="POST">
            ...
            <label>Busqueda Por Mascota</label>
            <br>
            <p>Ingrese ID de Mascota</p>
            <input type="text" name="idMascota" id="idMascota"/>
            <br>
